...
class DisplayYearlyTasksList extends StatelessWidget {
  const DisplayYearlyTasksList({
    super.key,
    required this.tasks,
    required this.selectedYear,
    required this.next12MonthsDate,
    required this.selectedYearMonth,
    required this.selectedYearMonthIndex,
  });
  ...
  Widget build(BuildContext context) {
    final selectedMonthLastDay = AHelperFunctions.getDaysInMonth(
      selectedYear,
      next12MonthsDate[selectedYearMonthIndex].month,
    );
    ...
    return Expanded(
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          final daysString = '${selectedMonthDays[index]} $selectedYearMonth';
          ...
          final matchingTodoTasks =
              tasks[0].where((task) {
                ...
                return task['date'].year == selectedYear &&
                    task['date'].month ==
                        next12MonthsDate[selectedYearMonthIndex].month &&
          ...
          final matchingEventsTasks =
              tasks[1].where((event) {
                ...
                return items.any((item) {
                  ...
                  return item['date'].year == selectedYear &&
                      item['date'].month ==
                          next12MonthsDate[selectedYearMonthIndex].month &&
          ...
          final matchingMilestonesTasks =
              tasks[2].where((task) {
                ...
                return task['due_date'].year == selectedYear &&
                    task['due_date'].month ==
                        next12MonthsDate[selectedYearMonthIndex].month &&
